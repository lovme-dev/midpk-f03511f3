...
serve(async (req) => {
  ...
  try {
    ...
    const successUrl = "https://www.midasbuy.com.pk/payment/success";
    const failureUrl = "https://www.midasbuy.com.pk/payment/failed";
    const checkoutUrl = "https://www.midasbuy.com.pk/checkout";
