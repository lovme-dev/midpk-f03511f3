...
BEGIN
  ...
  -- Pending orders now stay visible for 24 hours (previously 30 minutes) so that a
  -- card charge that succeeded at the gateway but never reached our thank-you page
  -- is never silently removed from the admin panel.
