              ...
              <div className={`flex items-center mb-2`}>
                ...
                <div className={isMobile ? 'flex-1' : ''}>
                  <div className={`flex items-center ${isMobile ? 'flex-col items-start' : ''}`}>
                    <h1 className="sr-only">Buy Free Fire Diamonds — Official Midasbuy Top Up Store | Instant Delivery</h1>
                    <div aria-hidden="true" className={`text-white font-bold tracking-wide drop-shadow-lg ${isMobile ? 'text-sm mb-1' : 'text-2xl md:text-3xl'}`} style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.8), 0px 0px 20px rgba(0,0,0,0.6)' }}>FREE FIRE</div>
