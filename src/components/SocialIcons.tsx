    ...
    <div className="social-icons-container">
      ...
      <div className="social-icon">
        <a href="https://reddit.com" target="_blank" rel="noopener noreferrer" className="social-icon-circle">
          <img loading="lazy" decoding="async" src="/lovable-uploads/f4f2f784-b6a4-48a9-be79-c084902b7932.png" alt="Reddit" className="w-7 h-7" />
        </a>
      ...
      <div className="social-icon">
        <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="social-icon-circle">
          <img loading="lazy" decoding="async" src="/lovable-uploads/42cba23d-8136-416a-ab7f-891c674cbce4.png" alt="TikTok" className="w-7 h-7" />
        </a>
      ...
      <div className="social-icon">
        <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="social-icon-circle">
          <img loading="lazy" decoding="async" src="/lovable-uploads/615d3989-b8e1-46ea-8816-5dca1c08b5cc.png" alt="Discord" className="w-7 h-7" />
        </a>
      ...
      <div className="social-icon">
        <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="social-icon-circle">
          <img loading="lazy" decoding="async" src="/lovable-uploads/32950e1f-69dc-48bb-bed6-89690707947e.png" alt="YouTube" className="w-7 h-7" />
        </a>
      ...
      <div className="social-icon">
        <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="social-icon-circle">
          <img loading="lazy" decoding="async" src="/lovable-uploads/65626d97-fbb9-425d-9971-135bc680cee5.png" alt="X" className="w-6 h-6" />
        </a>
      ...
      <div className="social-icon">
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="social-icon-circle">
          <img loading="lazy" decoding="async" src="/lovable-uploads/a784386a-71a2-4d02-b3df-c904d9c9d80b.png" alt="Instagram" className="w-7 h-7" />
        </a>
      ...
      <div className="social-icon">
        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="social-icon-circle">
          <img loading="lazy" decoding="async" src="/lovable-uploads/547ca5b3-b8dc-42ea-abd6-103ab5cd2f45.png" alt="Facebook" className="w-7 h-7" />
        </a>
